...
public enum ContractType
{
    ...
    NoQueens,       // -6 per queen (or -8 with Ravage City / Chinese Poker)
    Hearts,         // -2 per heart, -6 for Ace of Hearts
    NoLastTwo,      // -10 second to last, -20 last (or -10/-25 with Chinese Poker)
    ...
    ChinesePoker,   // 4 points per beat (requires Ravage City)
        ...
        if (ChinesePokerModeEnabled)
        {
            return CurrentVersion switch
            {
                BarbuVersion.Modern => type switch
                {
                    ...
                    ContractType.NoLastTwo => "-25 points for the last trick. -10 points for the 2nd to last trick (-35 total)",
                    ...
                    ContractType.ChinesePoker => "+4 points per beat (+72 total)",
                    _ => ""
                },
                _ => type switch
                {
            ...
            if (Contract.ChinesePokerModeEnabled)
            {
                return Contract.CurrentVersion switch
                {
                    BarbuVersion.Modern => Type switch
                    {
                        ...
                        ContractType.NoLastTwo => "-25 for last trick, -10 for 2nd to last trick (-35)",
                        ...
                        ContractType.ChinesePoker => "+4 per beat (+72)",
                        _ => ""
                    },
                    _ => Type switch
                    {
